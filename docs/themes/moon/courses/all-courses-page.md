...
## What is a course enrolment page?
The course enrolment page is where users can enroll in a course. On this page, users can view course details such as the description, course sections, instructors, and more - but they cannot participate in the course yet. The course enrolment page is a great feature not only for selling courses but also for enhancing your courses and making them more attractive.

## Enable course enrolment page
To enable course enrolment page:

Go to: Theme settings > Courses > Course enrolment page.
Set the "Layout" option.
Preview course enrolment page
To preview course enrolment page:

Go to course.
Then go to "Participants" and make sure you're NOT enrolled in the course.
Click the "Course enrolment page" link .
Add the "about the course" text
To add the "about the course" text:

## Edit course settings.
Add a short description into the "Course Summary" text area.
...
mb2video_local field - to add local video file.
