...
Please go to Site Administrator > Appearance > Themes > Edit the Unican theme's settings > Layout > Sub-Layout.
...
![unican-footer-bg.png](img/unican-footer-bg.png)
