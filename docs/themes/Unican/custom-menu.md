...
![unican-custom-menu.png](img/unican-custom-menu.png)
...
## How to get the menu custom URL

Please go to Site administrator > Appearance > Themes > Unican's theme settings > Layout > You can copy the page URL of each layout. 

![custom-menu.png](img/custom-menu.png)
